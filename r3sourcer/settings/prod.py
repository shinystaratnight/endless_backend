...
NO_REPLY_EMAIL = env('NO_REPLY_EMAIL', 'PiipAi Bot')
...
# Carrier List parameters from v1
# CARRIER_LIST_CHECK_TIMEDELTA_MINUTES = 10
CARRIER_LIST_MISSING_SKILL_MULTIPLIER = 2
# CARRIER_LIST_MISSING_SKILL_GAP_MULTIPLIER = 3
CARRIER_LIST_FILLING_TIME_DELTA = 16
