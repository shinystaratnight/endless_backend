...
# Stripe settings
STRIPE_PUBLIC_API_KEY = env('STRIPE_PUBLIC_API_KEY', 'pk_live_CZ0oWG7cIXXgWwv1BDMuSSgR')
STRIPE_SECRET_API_KEY = env('STRIPE_SECRET_API_KEY', 'sk_live_0yxDLN1ByPNVz72iSMGrSG0k')
STRIPE_PRODUCT_ID = env('STRIPE_PRODUCT_ID', 'prod_EeLiDSSx5axuzv')
