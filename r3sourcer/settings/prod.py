...
# Stripe settings
STRIPE_PUBLIC_API_KEY = env('STRIPE_PUBLIC_API_KEY', 'pk_test_2MvNXfKY5LWSSkOz241aYEs4')
STRIPE_SECRET_API_KEY = env('STRIPE_SECRET_API_KEY', 'sk_test_NdZFjPZh33RjbwGNXtRTd9Zm')
STRIPE_PRODUCT_ID = env('STRIPE_PRODUCT_ID', 'prod_ETreKcRLZTLAIy')
