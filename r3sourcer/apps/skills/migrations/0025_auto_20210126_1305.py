# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2021-01-26 13:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='work_types', to='skills.Skill', verbose_name='Skill')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='worktype',
            unique_together=set([('skill', 'name')]),
        ),
    ]
