...
CONTAINER_TYPES = (CONTAINER_ROW, CONTAINER_TABLE, CONTAINER_COLLAPSE, CONTAINER_HIDDEN, CONTAINER_COLUMN)
...
FIELD_LINKS_LIST = 'static'

DATEPICKER_TYPES = (FIELD_TIME, FIELD_DATE, FIELD_DATETIME)
NON_FIELDS_TYPES = (FIELD_BUTTON, FIELD_LINK, FIELD_SUBMIT, FIELD_TIMELINE, FIELD_LIST, FIELD_LINKS_LIST)
