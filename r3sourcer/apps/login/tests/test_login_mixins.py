...
from r3sourcer.apps.login.mixins import GenerateAuthTokenMixin
...
class TestGenerateTokenMixin:
    ...
    @mock.patch('r3sourcer.apps.login.mixins.get_random_string', side_effect=['1'*8, '2'*8])
    ...
    @mock.patch('r3sourcer.apps.login.mixins.get_random_string', side_effect=['1'*8, '2'*8, '3'*8])
