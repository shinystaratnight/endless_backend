...
from r3sourcer.apps.core.utils.geo import fetch_geo_coord_by_address, calc_distance, GMapsException
...
class TestGeo:
    ...
    def test_fetch_geo_coord_unsuccessfull(self, mock_googlemaps):
        ...
        result = fetch_geo_coord_by_address('test address')
    ...
    def test_calc_distance_unsuccessfull(self, mock_googlemaps):
        ...
        result = calc_distance('test address', ['test address 1', 'test address 2'])
        assert isinstance(result, bool) and not result
